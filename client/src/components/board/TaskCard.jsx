  ...
  return (
    <div
      ...
      className={`bg-white rounded-lg p-3 shadow-sm border border-slate-200 cursor-grab active:cursor-grabbing group
        ${isDragging ? 'shadow-xl rotate-2 scale-105' : 'hover:border-primary-300 hover:shadow-md'}
        transition-all`}
    >
      {/* Priority + Delete */}
      <div className="flex items-start justify-between gap-2 mb-2">
        ...
        <button
          ...
          className="opacity-0 group-hover:opacity-100 p-1 hover:bg-red-50 rounded text-slate-300 hover:text-red-500 transition"
        >
          <Trash2 size={13} />
        </button>
      </div>
      ...
      {/* Title */}
      <p
        className="text-sm font-medium text-slate-700 mb-2 leading-snug cursor-pointer hover:text-primary-600"
